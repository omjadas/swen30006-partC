...
public class util {
	...
	protected static float getDistanceManh(Coordinate from, Coordinate to) {
		return (float) (Math.abs(to.x - from.x) + Math.abs(to.y - from.y));
	}
	
	protected static String getTrapType (HashMap<Coordinate, MapTile> map, Coordinate coordinate) {
	...
	protected static ArrayList<Coordinate> getAllNeighbours(Coordinate position){
